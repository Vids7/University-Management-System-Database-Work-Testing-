...
public class LibrarianLoginServlet extends HttpServlet
{
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
    {
        ...
        String s1=req.getParameter("librarianid"); 
        ...
        try{
            ...
            rs = st.executeQuery("select * from librarian where librarian_id = '"+s1+"' and password ='"+s2+"'");
            if(rs.next())
            {
             res.sendRedirect("librarianprofile.html");  
            }
            else
            {
