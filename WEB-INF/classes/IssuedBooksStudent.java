...
public class IssuedBooksStudent extends HttpServlet
{
    public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
    {
        ...
        pw.println("<h1>Books Issued By Student</h1><br><br>");
        Connection con = null;
        Statement st = null;
        ResultSet rs=null;
        try{
        ...
        try{
            ...
            rs = st.executeQuery(" select book_id, book_name ,author_name, first_name, last_name from student natural join student_issued_books natural join books order by book_id");
